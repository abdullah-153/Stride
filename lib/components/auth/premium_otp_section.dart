...
class _PremiumOTPSectionState extends State<PremiumOTPSection> with TickerProviderStateMixin {
              ...
              children: [
                const Spacer(flex: 2),
                 ...
                 AnimatedContainer(
                   ...
                   decoration: BoxDecoration(
                     ...
                     boxShadow: [
                       BoxShadow(
                         color: widget.isLoading ? Colors.blue.withOpacity(0.2) : Colors.black.withOpacity(0.05),
                         blurRadius: 15,
                      ...
                      return AnimatedContainer(
                        ...
                        decoration: BoxDecoration(
                          color: _isError 
                              ...
                              : (isActive ? Colors.black : Colors.black12), // Glass style default (black12)
                          ...
                          boxShadow: isActive ? [
                            BoxShadow(
                              color: (_isError ? Colors.red : Colors.black).withOpacity(0.2),
                              blurRadius: 8,
                ...
                if (!widget.isLoading) ...[
                  ...
                  TextButton(
                   ...
                   const Spacer(flex: 2),
                   // Loading indicator is in the icon area, so just spacer here
                   Text(
                     "Verifying Code...",
                     style: TextStyle(
