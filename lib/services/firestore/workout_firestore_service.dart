...
class WorkoutFirestoreService extends BaseFirestoreService {
  static final WorkoutFirestoreService _instance =
  ...
  Future<void> saveCompletedWorkout(
    ...
    return handleFirestoreOperation(() async {
      final completionData = {
        ...
        FirestoreFields.difficulty: workout.difficulty
            .toString()
            .split('.')
            .last,
        FirestoreFields.completedAt: FieldValue.serverTimestamp(),
        FirestoreFields.actualDuration:
      ...
      await getUserSubcollection(
        userId,
        FirestoreCollections.completedWorkouts,
