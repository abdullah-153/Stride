...
class _GenerateDietPageState extends ConsumerState<GenerateDietPage>
            ...
            child: Column(
              ...
              children: [
                _buildAnimatedSection(
                  0,
                  _buildSectionTitle('Goal', isDarkMode),
                ),
                ...
                _buildAnimatedSection(
                  2,
                  _buildSectionTitle('Biometrics', isDarkMode),
                ),
                _buildAnimatedSection(
                  3,
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        PremiumSlider(
                          ...
                          max: 150,
                          onChanged: (v) =>
                              setState(() => _targetWeight = v.toInt()),
                          unit: ' kg',
                ...
                _buildAnimatedSection(
                  4,
                  _buildSectionTitle('Cuisine', isDarkMode),
                ),
                _buildAnimatedSection(
                  5,
                  Container(
                ...
                _buildAnimatedSection(
                  6,
                  _buildSectionTitle('Dietary Restrictions', isDarkMode),
                ),
                ...
                _buildAnimatedSection(
                  8,
                  _buildSectionTitle('Allergies', isDarkMode),
                ),
  ...
  Future<void> _generateDietPlan() async {
    ...
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => GeneratedDietPlanPage(dietPlan: plan),
        ),
      );
    } catch (e) {
      if (!mounted) return;
